...
struct ImageTypeTests {
  ...
  func webpValidation() async throws {
    ...
    let invalidWebP =
      "RIFF".data(using: .ascii)! + Data([0x20, 0x00, 0x00, 0x00]) + "WAVE".data(using: .ascii)!  // WAV file
  ...
  func heicValidation() async throws {
    ...
    let validHEIC =
      ...
      + "ftyp".data(using: .ascii)! + "heic".data(using: .ascii)! + Data(repeating: 0x00, count: 16)
    let invalidHEIC =
      Data([0x00, 0x00, 0x00, 0x20]) + "ftyp".data(using: .ascii)! + "jpeg".data(using: .ascii)!  // Wrong brand
  ...
  func avifValidation() async throws {
    ...
    let validAVIF =
      Data([0x00, 0x00, 0x00, 0x20])  // Size
      + "ftyp".data(using: .ascii)! + "avif".data(using: .ascii)! + Data(repeating: 0x00, count: 16)
    let invalidAVIF =
      Data([0x00, 0x00, 0x00, 0x20]) + "ftyp".data(using: .ascii)! + "heic".data(using: .ascii)!  // Wrong brand
