...
struct URLRoutingMultipartTests {
    ...
    struct MultipartFileUploadBasicTests {
        ...
        func testMultipartFileUploadRoundTripsCorrectly() throws {
            ...
            _ = try fileUpload.unapply(originalData)
    ...
    struct ErrorHandlingTests {
        ...
        func testMultipartErrorProvidesHelpfulErrorDescriptions() {
            ...
            let invalidContentTypeError = Multipart.FileUpload.MultipartError.invalidContentType(
                "bad/type"
            )
    ...
    struct ConversionExtensionTests {
        ...
        func testConversionMultipartStaticMethodWithCustomDecoder() {
            ...
            let multipartCoding: Multipart.Conversion<BasicUser> = .multipart(
                BasicUser.self,
                decoder: decoder
            )
    ...
    struct MultipartConversionBugFixTests {
        ...
        func testMultipartConversionProducesNonEmptyBody() throws {
            ...
            #expect(
                bodyString.contains("Content-Disposition: form-data; name=\"name\""),
                "Should contain name field header"
            )
        ...
        func testMultipartConversionHandlesMultipleFields() throws {
            ...
            #expect(
                bodyString.contains("true") || bodyString.contains("1"),
                "Should contain subscribed value"
            )

            // vars should be encoded somehow - check for at least one of the formats
            #expect(
                bodyString.contains("vars") || bodyString.contains("key1"),
                "Should contain vars data"
            )
        }
        ...
        func testMultipartConversionSkipsNilFields() throws {
            ...
            #expect(
                !bodyString.contains("name=\"address\""),
                "Should not contain nil address field"
            )
            #expect(!bodyString.contains("name=\"vars\""), "Should not contain nil vars field")
            #expect(
                !bodyString.contains("name=\"subscribed\""),
                "Should not contain nil subscribed field"
            )
        }
        ...
        func testMultipartConversionEncodesSpecialCharacters() throws {
            ...
            #expect(
                bodyString.contains("Hello & Goodbye")
                    || bodyString.contains("Hello%20%26%20Goodbye")
            )
